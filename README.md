...
axel-cli/0.10.1 darwin-x64 node-v14.19.1
$ axel --help [COMMAND]
USAGE
  $ axel COMMAND
...
...
_See code: [src/commands/db/import.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/db/import.ts)_
...
OPTIONS
  ...
  -h, --help         show CLI help
  -m, --match=match  name of table to match (ex: _test)
  -s, --silent       Do not ask for confirmation
```

_See code: [src/commands/db/sync.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/db/sync.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate.ts)_
...
_See code: [src/commands/generate/api.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate/api.ts)_
...
_See code: [src/commands/generate/controller.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate/controller.ts)_
...
_See code: [src/commands/generate/hook.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate/hook.ts)_
...
_See code: [src/commands/generate/model.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate/model.ts)_
...
_See code: [src/commands/generate/route.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate/route.ts)_
...
_See code: [src/commands/generate/test.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/generate/test.ts)_
...
_See code: [src/commands/hello.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/hello.ts)_
...
_See code: [src/commands/init.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/init.ts)_
...
_See code: [src/commands/new.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/new.ts)_
...
_See code: [src/commands/run.ts](https://github.com/enyosolutions-team/axel-cli/blob/v0.10.1/src/commands/run.ts)_
<!-- commandsstop -->
